...
void MD5Init_XXX (MD5_CTX *context)                                       /* context */
{
 ...
 * context.
 */
void MD5Update_XXX (MD5_CTX *context, unsigned char *input,unsigned int inputLen) /* length of input block */
{
 ...
 */
void MD5Final_XXX (unsigned char digest[16], MD5_CTX *context)
{
